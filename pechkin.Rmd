...
yerevan_split <- apts_in_yerevan %>%
  ...
  initial_split(strate=price_usd)

yerevan_train <- training(yerevan_split)
yerevan_test <- testing(yerevan_split)
yerevan_metrics <- metric_set(accuracy, roc_auc, mn_log_loss)
...
yerevan_rec <- 
  ...
  step_date(posted_at, updated_at, features = c("month", "year"), keep_original_cols = FALSE) %>%
